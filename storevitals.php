 ...
 * Description:       Read-only WooCommerce store health diagnostics for products, checkout, orders, payments, shipping, and system configuration.
 * Version:           1.0.0
...
define( 'STOREVITALS_VERSION', '1.0.0' );
